...
const (
	...
	// ProxyProtocolTlvProcessor sets ppv2 tlvs as http headers and/or l7 dynamic metadata
	ProxyProtocolTlvProcessor = "envoy.filters.http.proxy_protocol_tlv_processor"
)
